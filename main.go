...
func main() {
	...
	flag.IntVar(&scale, "scale", 10, "The scale of the output image. An icon with 'size' 16 and 'scale' 1 will measure 16x16 pixels. An icon with 'size' 16 and 'scale' 2 will measure 32x32 pixels.")
